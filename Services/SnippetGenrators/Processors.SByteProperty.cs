...
{
    public SnippetInputPayload SByteProperty
    {
        get
        {
            return new()
            {
                Header = new()
                {
                    Title = "sByte Property Generator",
                    Author = "Ekalaivan Chidambaram - EkaToolFusion",
                    Description = "This will generates sbyte property with auto implemented accessors.",
                    Keywords = ["sbyte", "Property"],
                    Shortcut = "mksbyteprop",
                ...
                Body = new()
                {
                    ...
                    CodeBlock = new()
                    {
                        ...
                        Kind = "cData",
                        Delimiter = "$",
                        Code = @"public sbyte $PropName$ { get; set; }"
                    }
                }
            };
        }
